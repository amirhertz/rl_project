...
def dqn_learing(
    ...
    optimizer = optimizer_spec.constructor(model.parameters(), **optimizer_spec.kwargs)
    ...
    for t in count():
        ...
        if (t > learning_starts and
            ...
            current_Q_values =  model(obs_batch).gather(1, act_batch.unsqueeze(1))#[0, act_batch]
